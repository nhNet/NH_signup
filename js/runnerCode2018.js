    ...
    if (allAccounts.includes(profileEmail) === true) { //check if account actually exists in the array
              ...
              setTimeout(function() {
                  ...
                  document.body.innerHTML = '<img style="border:2px solid white;background:url(https://htmlcolorcodes.com/assets/images/html-color-codes-color-tutorials-hero-00e10b1f.jpg) no-repeat; background-size:200px 200px;margin-top:-13%;margin-left:27.33333333333333%;border-radius:100%" height="200px" width="200px" src="' + profileImg + '">' +
                      ...
                      '<img style="margin-left:46.6%;margin-top:-50px" width="80px" src="https://nhnet.github.io/NH_login/img/load.gif">' +
                      '<h1 style="margin-top:-50px;text-align:center">You have already logged in!<br><br>Loading NH Net Browser</h1>';
                  setTimeout(function() {
